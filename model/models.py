...
class Encoder(nn.Module):
    def __init__(self, hashbit):
        ...
        self.l1 = nn.Linear(512*20*20, hashbit)
...
class GlobalDiscriminator(nn.Module):
    def __init__(self, hashbit):
        ...
        self.l0 = nn.Linear(32 * 22 * 22 + hashbit, 512)
...
class LocalDiscriminator(nn.Module):
    def __init__(self, hashbit):
        super().__init__()
        self.c0 = nn.Conv2d(128+hashbit, 512, kernel_size=1)
...
class PriorDiscriminator(nn.Module):
    def __init__(self, hashbit):
        super().__init__()
        self.l0 = nn.Linear(hashbit, 1000)
